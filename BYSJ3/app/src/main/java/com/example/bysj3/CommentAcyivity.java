...
public class CommentAcyivity extends AppCompatActivity implements View.OnClickListener {
        ...
        public boolean handleMessage(@NonNull Message msg) {
            switch (msg.what) {
                case 4:
                    ...
                    Toast.makeText(CommentAcyivity.this, result, Toast.LENGTH_SHORT).show();
                        finish();
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.tv_comment:
                ...
                if (comment.length() == 0) {
                    Toast.makeText(CommentAcyivity.this, "请输入内容 ", Toast.LENGTH_SHORT).show();
                } else {
                    new Thread(new Runnable() {
                        @Override
                        public void run() {
                            String result = HttpComment.AddData(
